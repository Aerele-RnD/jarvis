		...
		<main style="flex:1;display:flex;flex-direction:column;height:100%;min-width:0;background:var(--surface);">
			<header style="height:52px;flex:none;border-bottom:1px solid var(--border);display:flex;align-items:center;padding:0 18px;gap:12px;">
				...
				<div style="margin-left:auto;display:flex;align-items:center;gap:8px;">
					<!-- "Go to Desk" — always the LEFTMOST item of the right cluster
					     (uniform with LayoutHeader across every page) -->
					<button class="jv-iconbtn" @click="openErpDesk" title="Open ERPNext Desk" aria-label="Open ERPNext Desk" style="width:32px;height:32px;display:flex;align-items:center;justify-content:center;background:transparent;border:none;border-radius:7px;cursor:pointer;">
					...
					<button class="jv-iconbtn" @click="toggleTheme" :title="effectiveDark ? 'Switch to light theme' : 'Switch to dark theme'" style="width:32px;height:32px;display:flex;align-items:center;justify-content:center;background:transparent;border:none;border-radius:7px;cursor:pointer;">
