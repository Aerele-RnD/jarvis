...
export const LIGHT_VARS = {
	...
	"--blue": "#1c1c22", "--blue-fg": "#ffffff", "--blue-bg": "#f1f1f4", "--blue-bd": "#e2e2e8",
...
// Dark = "Refined Indigo": neutral charcoal surfaces. Primary accent (--blue) is
// monochrome (near-white), paired with --blue-fg (near-black) for on-accent text/icons.
export const DARK_VARS = {
	...
	"--blue": "#ececf0", "--blue-fg": "#1c1c22", "--blue-bg": "#26262d", "--blue-bd": "#3a3a45",
