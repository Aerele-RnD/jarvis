			...
			<div v-else class="slide">
				...
				<div class="mock">
					...
					<div class="mock-body">
						...
						<div class="m-main">
							<div class="m-grid">
								<div class="m-card"><div class="ico"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx='11' cy='11' r='8' /><path d='m21 21-4.35-4.35' /></svg></div><div class="nm">Close Auditor</div><div class="ds">Read-only period-end integrity checks on your books</div><span class="m-inst on">Installed</span></div>
